...
{
    internal sealed class SilverDoorInteract : InteractableObject
    {
        ...
        [SerializeField]
        private string m_NotificationText = "You require a silver key to open this door.";
        ...
        // If we don't have the key, display notification
        ...
        public override void Interact()
        {
            ...
            if (!m_Inventory.HasItem(typeof(SilverKey)))
            {
            ...
            m_Inventory.RemoveItem(typeof(SilverKey));
        }
    }
}
