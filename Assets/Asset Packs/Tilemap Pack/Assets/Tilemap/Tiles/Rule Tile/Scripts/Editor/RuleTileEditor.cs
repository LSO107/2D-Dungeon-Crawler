...
using System.Linq;
using Asset_Packs.Tilemap_Pack.Assets.Tilemap.Tiles.Rule_Tile.Scripts;
...
namespace UnityEditor
{
	...
	internal class RuleTileEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			tile.m_DefaultGameObject = EditorGUILayout.ObjectField("Default Game ObjectDefinition", tile.m_DefaultGameObject, typeof(GameObject), false) as GameObject;
		...
		internal static void RuleInspectorOnGUI(Rect rect, RuleTile.TilingRule tilingRule)
		{
			float y = rect.yMin;
			EditorGUI.BeginChangeCheck();
            GUI.Label(new Rect(rect.xMin, y, k_LabelWidth, k_SingleLineHeight), "Game ObjectDefinition");
